...
function Page() {
  return (
    <div className='md:flex flex-wrap'>
        ...
        <img src="src/assets/menu_page-0005.jpg" className='w-full h-full md:w-1/2' alt="" />
        <img src="src/assets/menu_page-0006.jpg" className='w-full h-full md:w-1/2' alt="" />
        <img src="src/assets/menu_page-0007.jpg" className='w-full h-full md:w-1/2' alt="" />
    </div>
  )
}
